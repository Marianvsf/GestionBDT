        ...
        <div class="container mx-auto px-6 flex flex-col">
            <div class="flex items-center justify-between h-full">
                ...
                <?php if(isset($_SESSION['user_id']) && $currentRoute !== 'home' && $currentRoute !== 'login' || $currentRoute == 'help'): ?>
                    <a href="?route=dashboard" class="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-200 focus:outline-none focus:ring-slate-300/60">
