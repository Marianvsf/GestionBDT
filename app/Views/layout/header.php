...
<body class="bg-gray-50 text-slate-800 antialiased font-sans flex flex-col min-h-screen">
    ...
    <main class="flex-grow flex w-full pt-16">
        <div class="w-full grid grid-cols-1 lg:grid-cols-2 min-h-[calc(100vh-4rem)]">
            ...
            <div class="flex items-center justify-center bg-white px-4 sm:px-6 lg:px-8 relative">
    ...
    <script>
        ...
        window.addEventListener('scroll', () => {
            if (window.scrollY > 20) { 
                nav.classList.remove('nav-top'); nav.classList.add('nav-scrolled');
            } else {
                nav.classList.add('nav-top'); nav.classList.remove('nav-scrolled');
            }
        });
